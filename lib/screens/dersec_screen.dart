...
class _DersSecState extends State<DersSec> {
  ...
  void handleFlip(int index, bool locked) {
    if (locked) return; // kilitliyken dönmeisn diye bu kısım var
    setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          // arkaplanı buradan belirliyoruz
          SizedBox.expand(
            child: Image.asset(
              'assets/arkaplan.png',
              fit: BoxFit.cover,
